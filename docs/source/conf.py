...
latex_documents = [
    (master_doc, 'wtools.tex', 'wtools Documentation',
...
man_pages = [
    (master_doc, 'wtools', 'wtools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wtools', 'wtools Documentation',
     author, 'wtools', 'One line description of project.',
     'Miscellaneous'),
]
